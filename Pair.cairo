...
@contract_interface
namespace ICairoFiSwapCallee {
    func CairoFiswap_call(
...
func initializer{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    ERC20.initializer('CairoFiSwap Pair', 'CairoFi-P', 18);
    _locked.write(0);
...
func swap{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    if (data_len_greater_than_zero == 1) {
        ICairoFiSwapCallee.CairoFiswap_call(
            contract_address=to,
